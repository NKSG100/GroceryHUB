        ...
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                <h1 className="text-3xl font-medium mb-6">
                    My Cart <span className="text-sm text-indigo-500">{getCartCount()} Items</span>
                </h1>
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer bg-indigo-400 text-white font-medium hover:bg-indigo-600 transition">
