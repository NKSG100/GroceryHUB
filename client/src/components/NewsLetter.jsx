...
const Newsletter = () => {
  return (
    <div className="flex flex-col items-center w-full max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gradient-to-r from-indigo-500 to-indigo-900 text-white">
      <div className="flex flex-col justify-center items-center text-center">
        ...
        <p className="text-sm md:text-base text-gray-200 mt-2 max-w-xl">
          Join our GroceryHUB Family and be the first to discover new updates,
          exclusive offers on insane grocery deals.
        </p>
      </div>
