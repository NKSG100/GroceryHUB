...
const AddAddress = () => {
  ...
  return (
    <div className='mt-16 pb-16'>
        <p className='text-2xl md:text-3xl test-gray-500'>Add Shipping <span className='font-semibold text-indigo-500'>Address</span> </p>
        <div className='flex flex-col md:flex-row justify-between mt-10'>
            <div className='flex-1 max-w-md'>
                <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                    <div className='grid grid-cols-2 gap-4'>
                        <InputField handleChange={handleChange} address={address} name="firstName" type="text" placeholder="First Nmae"/>
                        <InputField handleChange={handleChange} address={address} name="lastName" type="text" placeholder="Last Nmae"/>
                    </div>
                    ...
                    <button className='w-full mt-6 bg-indigo-400 text-white py-3 hover:bg-indigo-600 transition cursor-pointer uppercase'>
                        Save Address
                    </button>
                </form>
            </div>
